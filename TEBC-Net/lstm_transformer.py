...
class lstm_TransformerEncoder(nn.Module):
    ...
    def __init__(self, config,d_model=300, n_layers=3, n_heads=10, p_drop=0.1, d_ff=2048, pad_id=0):
        super(lstm_TransformerEncoder, self).__init__()
        self.config = config
    ...
    def forward(self,inputs):
        ...
        for layer in self.layers:
            ...
            # print('outputsssss是不是tensor:')
            # print(torch.is_tensor(outputs))
            # |outputs| : (batch_size, seq_len, d_model)
