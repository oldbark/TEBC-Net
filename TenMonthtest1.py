...
class Tentest1(nn.Module):
    def __init__(self, config):
        super(Tentest1, self).__init__()
        self.config = config
    ...
    def forward(self, x):
        ...
        transformer = self.transformerEncoder(Transformer_input, mask)
        transformer = nn.Linear(300,250)(transformer)
